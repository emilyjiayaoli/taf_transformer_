...
def get_max_preds(batch_heatmaps):
    ...
    #print('batch_heatmaps.ndim', batch_heatmaps.ndim)
    ...
    #print('preds shape is', preds.shape) #(25, 17, 2)
    #print('maxvals shape is', maxvals.shape) #(25, 17, 1)
...
def get_final_preds(config, hm, center, scale):
    ...
    #print('coords shpae is ', coords.shape) #(25, 17, 2)
    #print('center shpae is ', center.shape) #(1, 2)
    ...
    for i in range(coords.shape[0]):
        ...
        preds[i] = transform_preds(
            coords[i], 
            center, #used to be center[i]
            scale, #used to be scale[i]
