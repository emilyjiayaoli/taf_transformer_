...
class JointsDataset(Dataset):
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        self.root = root #passed in from coco.py
    ...
    '''def _get_db(self):
      #note that currently it is temporaroly set to retrieve only coco dataset
        db_tempobj= COCODataset()
        tmp_db = db_tempobj.db
        return tmp_db
    '''
