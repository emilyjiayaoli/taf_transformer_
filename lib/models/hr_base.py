...
class HRNET_base(nn.Module):
    ...
    def init_weights(self, pretrained='', print_load_info=False):
        ...
        pretrained = "/content/drive/MyDrive/*learning2022/research_project/TokenPose"+pretrained 
        ...
        if os.path.isfile(pretrained):
            ...
            #print('length of existing_state_dict is {}'.format(len(existing_state_dict))) #--> length is 775
